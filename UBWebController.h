...
//        bool hasEmbeddedContent();//项目没用到
//        void hasEmbeddedContent();
        void getEmbeddableContent();//项目没用到
    ...
    signals:
        ...
        // add for teacher by nick wu
        void imageTeacherCaptured(const QPixmap& pCapturedPixmap, bool pageMode, const QUrl& source);
