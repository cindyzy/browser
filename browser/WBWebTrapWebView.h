...
//        void objectCaptured(const QUrl& pUrl, const QString& pMimeType, int pWidth, int pHeight);"没用到"
    ...
    protected:
        ...
        void potentialEmbedCodeAtPos(const QPoint& pos, const QString &method);
        enum WebContentType
        {
